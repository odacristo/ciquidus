...
if (settings.heavy != true) {
  ...
  'getbznodecount', 'getbznodecountonline', 'getbznodelist', 'getvotelist', 'getblockcount', 'getblockhash', 'getblock', 'getrawtransaction', 
  ...
  */
  chaincoinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount',
    'getbznodecount', 'getbznodecountonline', 'getbznodelist', 'getvotelist', 'getblockcount', 'getblockhash', 
